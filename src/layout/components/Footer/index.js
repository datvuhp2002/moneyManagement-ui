      ...
      <Row className={cx("")}>
        <Col>
          <div className={cx("content", "d-flex align-items-center")}>
            <Button header className={cx("logo", "flex-shrink-0 me-2")} to="/">
        ...
        <Col className={cx("danhgia", "mt-4")}>
          ...
          <ul>
            <li>
              Cảm ơn bạn đã tin tưởng và sử dụng dịch vụ Quản Lý Thu Chi Cá nhân
              để quản lý tài chính của nhóm tôi. Mọi góp ý xin vui lòng gửi
              email tới địa chỉ Nhom4@gmail.com để được giải đáp cũng như hỗ trợ
              khách hàng trong thời gian sớm nhất.
            </li>
          </ul>
          <div className={cx("icon-buttons", "d-flex", "justify-content-end")}>
            <Button
              variant="primary"
