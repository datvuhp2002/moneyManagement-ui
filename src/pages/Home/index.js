  ...
  return (
    ...
    <div className="bank-card-container">
      ...
      <div className="bank-card">
        <div className="card-details">
          <h2>Tổng Tiền Chi</h2>
          <p className="card-number" style={{ color: "#FF5733"}}>{tongTienChi.toLocaleString()} VND</p>
        </div>
      </div>
      ...
      <div className="bank-card">
        <div className="card-details">
          <h2>Tổng Tiền Thu</h2>
          <p className="card-number" style={{ color: "#8884d8" }}>{tongTienThu.toLocaleString()} VND</p>
        </div>
      </div>
     </div>
